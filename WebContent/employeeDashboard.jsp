...
<div class="container">
    ...
    <div class="info-grid">
        <!-- MY PROFILE - Links to Employee Profile Servlet -->
        <div class="info-card">
        ...
        <!-- SALARY - Links to Employee Salary Servlet -->
        <div class="info-card">
            <div class="info-icon">[ $ ]</div>
            <h4>SALARY</h4>
            <p>View your salary details</p>
            <a href="employee-salary">VIEW SALARY</a>
        </div>
        
        <!-- ANNOUNCEMENTS - Links to Announcements Servlet (Shows real data or no updates) -->
        <div class="info-card">
            <div class="info-icon">[ ! ]</div>
            <h4>ANNOUNCEMENTS</h4>
            <p>Company news and updates</p>
            <a href="employee-announcements">READ MORE</a>
        </div>
        
        <!-- SUPPORT - Links to Support Page -->
        <div class="info-card">
            <div class="info-icon">[ ? ]</div>
            <h4>SUPPORT</h4>
            <p>Get help and raise tickets</p>
            <a href="employee-support">CONTACT HR</a>
        </div>
    </div>
